...
function result() {
    ...
    while (newStory.includes(":inserty:")) {
    ...
    if (customName.value !== "") {
        // STEP 10a: Create a variable called name and set it equal to the value of customName
        var name = customName.value;
        // STEP 10b: Replace the string 'Bob' in the newStory variable with the name variable
